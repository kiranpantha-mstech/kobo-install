...
services:
  kobocat:
    ...
    ${USE_EXTRA_HOSTS}extra_hosts:
      ...
      ${USE_FAKE_DNS}- ${DIGITAL_SUBDOMAIN}.${PUBLIC_DOMAIN_NAME}:${LOCAL_INTERFACE_IP}
  ...
  digital_worker:
    ...
    ${USE_BACKEND_NETWORK}  kobo-be-network:
    ${USE_BACKEND_NETWORK}    aliases:
    ${USE_BACKEND_NETWORK}      - digital_worker
    ${USE_BACKEND_NETWORK}      - digital.docker.container
  ...
  digital_beat:
    ...
    ${USE_BACKEND_NETWORK}  kobo-be-network:
    ${USE_BACKEND_NETWORK}    aliases:
    ${USE_BACKEND_NETWORK}      - digital_beat
    ${USE_BACKEND_NETWORK}      - digital.docker.container
    ...
    networks:
      kobo-fe-network:
        aliases:
          ...
          - ${DIGITAL_SUBDOMAIN}.${INTERNAL_DOMAIN_NAME}
...
${USE_BACKEND_NETWORK}      name: ${DOCKER_PREFIX}_kobo-be-network
